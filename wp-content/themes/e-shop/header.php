...
<html >
    <head>
        ...
        <!-- //for bootstrap working -->
        <!-- cart -->
        <script src="<?php echo get_template_directory_uri(); ?>/js/simpleCart.min.js"></script>
        <!-- cart -->
                ...
                <div class="container">
                    <div class="header-top-left">
                        <ul>
                            ...
                            <li><a href=".#/registeration"><span class="glyphicon glyphicon-lock"> </span>Create an Account</a></li>			
                        </ul>
                    </div>
                        ...
                        <div class="cart box_1">
                            <a href="checkout.html">
                                <h3> <span class="simpleCart_total"> $0.00 </span> (<span id="simpleCart_quantity" class="simpleCart_quantity"> 0 </span>)
                                    <img src="<?php echo get_template_directory_uri(); ?>/images/bag.png" alt=""></h3>
                            </a>	
